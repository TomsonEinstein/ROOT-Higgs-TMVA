...
void TMVA_BDT_HZZ_Classification_10() {
  ...
  auto outputFile = TFile::Open("TMVA_BDT_4lep_10.root", "RECREATE");

  TMVA::Factory factory("TMVA_BDT_HZZ_Classification_10", outputFile,
...
//   loader->AddSpectator("lep_etcone20[2]");
//   loader->AddSpectator("lep_etcone20[3]");
...
//   loader->AddSpectator("jet_pt_syst");
  ...
  // Boosted Decision Trees
    factory.BookMethod(
        ...
        "!V:NTrees=800:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:"
        "AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.6:"
